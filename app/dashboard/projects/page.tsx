...
export default async function OwnerDashboard() {
  ...
  const projectsWithMilestones = projects.map((project, i) => ({
    ...project,
...
function OwnerProjectsClient({ projects }: { projects: any[] }) {
    ...
    <div className="flex min-h-svh flex-col bg-background">
      <main className="mx-auto w-full max-w-6xl px-4 py-8 sm:py-12">
        ...
        <div className="mb-8 flex items-center justify-between">
          ...
          <a href="/dashboard/projects/new" className="inline-flex items-center gap-2 rounded-lg bg-primary px-4 py-2 text-sm font-medium text-primary-foreground hover:bg-primary/90 transition">
